...
export default (config = {}) => {
  const breakoutBlockType = config.breakoutBlockType || defaults.breakoutBlockType
  const breakoutBlocks = config.breakoutBlocks || defaults.breakoutBlocks
  const doubleBreakoutBlocks = config.doubleBreakoutBlocks || defaults.doubleBreakoutBlocks
